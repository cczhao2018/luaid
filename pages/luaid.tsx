...
export default function Home() {
  ...
  const handleAnswer = async () => {
    ...
    const prompt = endent`
    You are a Biology teacher now, use the Markdown to format the answer of query: "${query}"
    `;
        ...
        <div className="flex-1 overflow-auto">
          <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
            ...
            {loading ? (
              ...
              <div className="mt-6 text-center text-lg">{`AI-powered search & chat for Biology education.`}</div>
            )}
          </div>
        </div>
        <Footer />
